...
/**
 * Class for Zend\ViewHelper\Strategy\PhpRendererStrategy to help enforce private constructs.
 *
...
class PhpRenderer implements Renderer, TreeRendererInterface
{
        ...
        if ($nameOrModel instanceof Model) {
            ...
            if (empty($nameOrModel)) {
                throw new Exception\DomainException(sprintf(
                    '%s: received ViewHelper Model argument, but template is empty',
                    __METHOD__
                ));
            }
     ...
     *
     * If set to true, the ViewHelper instance will not attempt to render children
    ...
    /**
     * Make sure ViewHelper variables are cloned when the view is cloned.
     *
     * @return PhpRenderer
     */
