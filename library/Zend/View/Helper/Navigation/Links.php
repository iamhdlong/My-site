...
class Links extends AbstractHelper
{
     ...
     * $h->findRevSection($page); // $h->findRelation($page, 'rev', 'sections');
     ...
     *                                prev, sections, start, stylesheet,
     *                                subsection
     * @return string
    ...
    /**
     * Searches the root container for forward 'sections' relations of the given
     * $page
     *
     * From {@link http://www.w3.org/TR/html4/types.html#type-links}:
     * Refers to a document serving as a sections in a collection of documents.
     *
     * @param  AbstractPage $page
     * @return AbstractPage|array|null
     */
    ...
    /**
     * Searches the root container for the reverse 'sections' relation of the
     * given $page
     *
     * From {@link http://www.w3.org/TR/html4/types.html#type-links}:
     * Refers to a document serving as a sections in a collection of documents.
