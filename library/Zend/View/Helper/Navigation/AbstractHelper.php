    ...
    TranslatorAwareInterface
{
    ...
    protected function parseContainer(&$container = null)
    {
        ...
        if (is_string($container)) {
             ...
             * and not in the ViewHelper\HelperPluginManager. If the set service locator is a
     ...
     *
     * Overloads {@link ViewHelper\Helper\AbstractHtmlElement::htmlAttribs()}.
     *
     ...
     * Normalize an ID
     *
     * Overrides {@link ViewHelper\Helper\AbstractHtmlElement::normalizeId()}.
     *
     * @param  string $value
     * @return string
     */
