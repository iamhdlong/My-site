 ...
 *
 * - ViewHelperManager (also aliased to Zend\ViewHelper\HelperPluginManager)
 * - ViewTemplateMapResolver (also aliased to Zend\ViewHelper\Resolver\TemplateMapResolver)
 * - ViewTemplatePathStack (also aliased to Zend\ViewHelper\Resolver\TemplatePathStack)
 * - ViewResolver (also aliased to Zend\ViewHelper\Resolver\AggregateResolver and ResolverInterface)
 * - ViewRenderer (also aliased to Zend\ViewHelper\Renderer\PhpRenderer and RendererInterface)
 * - ViewPhpRendererStrategy (also aliased to Zend\ViewHelper\Strategy\PhpRendererStrategy)
 * - ViewHelper (also aliased to Zend\ViewHelper\ViewHelper)
 * - DefaultRenderingStrategy (also aliased to Zend\Mvc\ViewHelper\Http\DefaultRenderingStrategy)
 * - ExceptionStrategy (also aliased to Zend\Mvc\ViewHelper\Http\ExceptionStrategy)
 * - RouteNotFoundStrategy (also aliased to Zend\Mvc\ViewHelper\Http\RouteNotFoundStrategy and 404Strategy)
 * - ViewModel
 */
class ViewManager extends AbstractListenerAggregate
{
    ...
    public function getView()
    {
        ...
        $this->services->setService('ViewHelper', $this->view);
        $this->services->setAlias('Zend\View\View', 'ViewHelper');
