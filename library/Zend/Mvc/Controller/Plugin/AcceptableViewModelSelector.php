...
/**
 * Controller Plugin to assist in selecting an appropriate ViewHelper Model type based on the
...
class AcceptableViewModelSelector extends AbstractPlugin
{
     ...
     * @throws InvalidArgumentException If the supplied and matched ViewHelper Model could not be found
    ...
    public function getViewModel(
        ...
        if (!class_exists($name)) {
            throw new InvalidArgumentException('The supplied ViewHelper Model could not be found');
        }
    ...
    /**
     * Set the default ViewHelper Model (name) to return if no match could be made
     * @param string $defaultViewModelName The default ViewHelper Model name
    ...
    /**
     * Set the default Accept Types and ViewHelper Model combinations to match against if none are specified.
     *
     * @param array $matchAgainst (optional) The Array to match against
     * @return AcceptableViewModelSelector provides fluent interface
     */
    ...
    /**
     * Get the default Accept Types and ViewHelper Model combinations to match against if none are specified.
     *
     * @return array|null
     */
